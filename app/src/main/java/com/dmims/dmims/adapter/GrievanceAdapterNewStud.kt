...
class GrievanceAdapterNewStud(userlist: ArrayList<StudentGrievanceGet>, context: Context) :
    RecyclerView.Adapter<GrievanceAdapterNewStud.ViewHolder>(), View.OnClickListener {
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): GrievanceAdapterNewStud.ViewHolder {

        val view=LayoutInflater.from(p0.context).inflate(R.layout.grievance_adapter_newstud_layout,p0,false)
    ...
    class ViewHolder (itemView:View, ctx: Context, list: List<StudentGrievanceGet>):RecyclerView.ViewHolder(itemView){
     ...
     //   val viewfile=itemView.findViewById<TextView>(R.id.tv_viewFile)
        ...
        init {
            ...
            ll_onClick.setOnClickListener {
                ...
                // Code for JGP, PNG
                if ((b.contains(".jpg",ignoreCase = true))||(b.contains(".jpeg",ignoreCase = true))||(b.contains(".png",ignoreCase = true)))
                {
                    ...
                    {
                        GenericUserFunction.DisplayToast(ctx,"No Attachment Found")
                    }
