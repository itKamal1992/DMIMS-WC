...
import kotlinx.android.synthetic.main.activity_convenor_dashboard.*


import java.util.*
import kotlin.system.exitProcess

class ConvenorDashboard : AppCompatActivity()
{
...
//    private var roleadmin: String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_convenor_dashboard)
...
//        var key_designation: String? = mypref.getString("key_designation", null)
        ...
        navigation_view.setNavigationItemSelectedListener {
            when (it.itemId) {
                R.id.action_view_grievance -> {
                    val intent = Intent(this@ConvenorDashboard, ViewRegGrievHod::class.java)
                    startActivity(intent)
                }


                R.id.action_time_table -> {
                    val intent = Intent(this@ConvenorDashboard, Activity_time_table_student::class.java)
                ...
                R.id.action_logout -> {
                    ...
                    editor.clear()
                    editor.commit()
                    val intentlogout = Intent(this@ConvenorDashboard, SplashScreen::class.java)
    ...
    inner class MyTimerTask : TimerTask() {
        ...
        override fun run() {
            this@ConvenorDashboard.runOnUiThread(Runnable {
    ...
    private fun setNotice(notification: LinearLayout) {
        notification.setOnClickListener {
            val intent = Intent(this@ConvenorDashboard, Activity_Notification_Student::class.java)
    ...
    private fun setExam(exam_grid: LinearLayout) {
        exam_grid.setOnClickListener {
            val intent = Intent(this@ConvenorDashboard, Student_GET_UploadMCQ::class.java)
            startActivity(intent)
        }
    }
    ...
    private fun setEmergencyEvent(emergencygrid: LinearLayout) {
        emergencygrid.setOnClickListener {
            val intent = Intent(this@ConvenorDashboard, EmergencyContact::class.java)
            intent.putExtra("info", "Notice Board Activity")
            startActivity(intent)
        }
    }
...
//            intent.putExtra("info", "Notice Board Activity")
//            startActivity(intent)
            this@ConvenorDashboard.startActivity(
                Intent(
                    Intent.ACTION_VIEW,
    ...
    private fun septicaemicCalEvent(academic_cal_board: LinearLayout) {
        academic_cal_board.setOnClickListener {
            val intent = Intent(this@ConvenorDashboard, AcademicCalender::class.java)
    ...
    private fun setGrievanceGridEvent(greviancegrid: LinearLayout) {
        greviancegrid.setOnClickListener {
            val intent = Intent(this@ConvenorDashboard, GreivanceStudFile::class.java)
            val mypref = getSharedPreferences("mypref", Context.MODE_PRIVATE)
            var student_id_key = mypref.getString("Stud_id_key", null)
            intent.putExtra("stud_k", student_id_key?.toString())
            startActivity(intent)
    ...
    private fun setFeedbackGridEvent(feedback_grid: LinearLayout) {
        feedback_grid.setOnClickListener {
            ...
            val intent = Intent(this@ConvenorDashboard, FeedbackOptionActivity::class.java)
            val mypref = getSharedPreferences("mypref", Context.MODE_PRIVATE)
            var student_id_key = mypref.getString("Stud_id_key", null)
            intent.putExtra("stud_k", student_id_key?.toString())
            startActivity(intent)
    ...
    private fun dialogCall(Title:String ) {
        val builder = android.app.AlertDialog.Builder(this@ConvenorDashboard)
        val dialogView = layoutInflater.inflate(R.layout.custom_dialog_exit, null)
