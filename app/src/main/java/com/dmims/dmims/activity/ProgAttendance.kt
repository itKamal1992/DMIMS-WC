...
class ProgAttendance : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_prog_attendance)
...
//        Toast.makeText(this@ProgAttendance, begining.toString() + "  and   " + end.toString(), Toast.LENGTH_SHORT)            .show()
        progressBar.visibility = View.VISIBLE
        try {
            mServices.GetProgressiveAttend(stud_k2!!.toInt(), admission_date, begining, COURSE_ID!!)
                .enqueue(object : Callback<APIResponse> {
                    override fun onFailure(call: Call<APIResponse>, t: Throwable) {
                        Toast.makeText(this@ProgAttendance, t.message, Toast.LENGTH_SHORT).show()
                    ...
                    override fun onResponse(call: Call<APIResponse>, response: Response<APIResponse>) {
                        ...
                        if (result!!.Status == "ok") {
                            ...
                            progressBar.visibility = View.INVISIBLE
                            Toast.makeText(this@ProgAttendance, result.Status, Toast.LENGTH_SHORT).show()
                        }
                    }
                })
