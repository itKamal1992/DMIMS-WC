...
class Exam_Current_InboxNoticeAdmin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_exam_current_notice)
            ...
            mServices.GetNotice(begining.toString(), end.toString())
                .enqueue(object : Callback<APIResponse> {
                    override fun onFailure(call: Call<APIResponse>, t: Throwable) {
                        ...
                        Toast.makeText(this@Exam_Current_InboxNoticeAdmin, t.message, Toast.LENGTH_SHORT).show()
                        ...
                        if (result!!.Status == "ok") {
                            ...
                            if(users.isEmpty())
                            {
                                GenericUserFunction.showOopsError(
                                    this@Exam_Current_InboxNoticeAdmin,
                                    "No Notices found for the current request"
                                )
                            }else {
                                val adapter = NoticeAdapterCurrent(users, this@Exam_Current_InboxNoticeAdmin)
                            ...
                            if (result.Status.equals("No data found", ignoreCase = true)) {
                                ...
                                GenericPublicVariable.CustDialog = Dialog(this@Exam_Current_InboxNoticeAdmin)
