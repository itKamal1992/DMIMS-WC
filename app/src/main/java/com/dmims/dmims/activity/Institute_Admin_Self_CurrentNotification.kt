...
class Institute_Admin_Self_CurrentNotification : AppCompatActivity() {
            ...
            mServices.GetNotice( begining.toString(), end.toString())
                .enqueue(object : Callback<APIResponse> {
                    override fun onFailure(call: Call<APIResponse>, t: Throwable) {
                        ...
                        Toast.makeText(this@Institute_Admin_Self_CurrentNotification, t.message, Toast.LENGTH_SHORT).show()
...
//                                                result!!.Data14!![i].DEPT_ID,
                            ...
                            if(users.isEmpty())
                            {
                                ...
                                GenericPublicVariable.CustDialog = Dialog(this@Institute_Admin_Self_CurrentNotification)
                                ...
                                val adapter = NoticeDeleteAdapterCurrent(users,this@Institute_Admin_Self_CurrentNotification)
                            ...
                            if (result.Status.equals("No data found", ignoreCase = true))
                            {
                                ...
                                Toast.makeText(
                                    this@Institute_Admin_Self_CurrentNotification,
                                    result.Status,
                                    Toast.LENGTH_SHORT
                                )
                                    .show()
