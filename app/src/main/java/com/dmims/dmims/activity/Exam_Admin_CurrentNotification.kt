...
class Exam_Admin_CurrentNotification : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_exam_admin_current_notice)
            ...
            mServices.GetNotice( begining.toString(), end.toString())
                .enqueue(object : Callback<APIResponse> {
                    override fun onFailure(call: Call<APIResponse>, t: Throwable) {
                        ...
                        Toast.makeText(this@Exam_Admin_CurrentNotification, t.message, Toast.LENGTH_SHORT).show()
...
//                                val adapter = NoticeDeleteAdapterCurrent(users,this@Institute_Admin_CurrentNotification)
                            ...
                            if (result.Status.equals("No data found", ignoreCase = true))
                            {
                                ...
                                GenericPublicVariable.CustDialog = Dialog(this@Exam_Admin_CurrentNotification)
                                ...
                                Toast.makeText(
                                    this@Exam_Admin_CurrentNotification,
                                    result.Status,
                                    Toast.LENGTH_SHORT
                                )
                                    .show()
