...
class Activity_Notification_Institute_Admin : AppCompatActivity() {
...
//    var date_of_admiss_k: String = "-"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.layout_activity_institute_admin_notification)
...
//                            val adapter = NoticeDeleteAdapterCurrent(users,this@Activity_Notification_Institute_Admin)
        ...
        btn_Check_self!!.setOnClickListener {
            val intent = Intent(this@Activity_Notification_Institute_Admin,Activity_Notification_SelfInstitute_Admin::class.java)
            startActivity(intent)
        }
