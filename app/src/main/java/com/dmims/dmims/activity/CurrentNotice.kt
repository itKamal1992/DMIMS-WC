...
class CurrentNotice : AppCompatActivity() {
            ...
            mServices.GetNotice(begining.toString(), end.toString())
                .enqueue(object : Callback<APIResponse> {
                    override fun onFailure(call: Call<APIResponse>, t: Throwable) {
                        ...
                        Toast.makeText(this@CurrentNotice, t.message, Toast.LENGTH_SHORT).show()
...
//                                        ???
                            ...
                            if(users.isEmpty()){
                                ...
                                GenericPublicVariable.CustDialog = Dialog(this@CurrentNotice)
                                ...
                                val adapter = NoticeAdapterCurrent(users,this@CurrentNotice)
