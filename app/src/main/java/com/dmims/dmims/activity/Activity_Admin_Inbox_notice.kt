...
class Activity_Admin_Inbox_notice : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.layout_activity_admin_notice)
...
//                                        ???
                                ...
                                if (result.Status.equals("No data found", ignoreCase = true)) {
                                    ...
                                    GenericUserFunction.showOopsError(
                                        this@Activity_Admin_Inbox_notice,
...
//                                        ???
                                ...
                                if (result.Status.equals("No data found",ignoreCase = true)) {
                                    ...
                                    progressBar!!.visibility = View.INVISIBLE
                                    progressBar!!.visibility = View.GONE
                                    GenericUserFunction.showOopsError(this@Activity_Admin_Inbox_notice,"No Notices found for the current request")
                                }
                                else {
                                    progressBar!!.visibility = View.INVISIBLE
                                    progressBar!!.visibility = View.GONE
                                    println("result 3>>>" + result.Status)
                                    Toast.makeText(this@Activity_Admin_Inbox_notice, result.Status, Toast.LENGTH_SHORT)
                                        .show()
                                }
                            }
                        }
