...
class Activity_Notification_SelfExam_Admin : AppCompatActivity() {
...
//    var date_of_admiss_k: String = "-"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.layout_activity_self_exam_admin_notification)
            ...
            mServices.GetNotice( to_date_sel,from_date_sel)
                .enqueue(object : Callback<APIResponse> {
                    override fun onFailure(call: Call<APIResponse>, t: Throwable) {
                        Toast.makeText(this@Activity_Notification_SelfExam_Admin, t.message, Toast.LENGTH_SHORT).show()
                        ...
                        if (result!!.Status == "ok") {
                            ...
                            for (i in 0..listSize - 1) {
                                if (result.Data14!![i].ADMIN_FLAG == "T") {
                                    ...
                                    if(Stud_id_key.equals(result.Data14!![i].USER_ID)){
                                    users.add(
                                        NoticeStudCurrent(
...
//                                            result.Data14!![i].DEPT_ID,
                            ...
                            if(users.isEmpty())
                            {
                                GenericUserFunction.showOopsError(
                                    this@Activity_Notification_SelfExam_Admin,
                                    "No Notices found for the current request"
                                )
                            }else{

                            val adapter = NoticeDeleteAdapterCurrent(users,this@Activity_Notification_SelfExam_Admin)
        ...
        btn_current_id!!.setOnClickListener {
            val intent = Intent(this@Activity_Notification_SelfExam_Admin,Exam_Admin_Self_CurrentNotification::class.java)
