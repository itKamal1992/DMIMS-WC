...
class GrievanceFull : AppCompatActivity() {
    ...
    lateinit var btn_ForwardedSubmit: Button
    ...
    lateinit var et_commentForwarded: EditText
    ...
    var tv_DateStr: String = ""
    var Griev_IdStr: String = ""
    var Griev_NameStr: String = ""
    var Griev_SubjectStr: String = ""
    var Griev_CategoryStr: String = ""
    var Griev_CompAgainstStr: String = ""
    var Griev_DescriptionStr: String = ""

    var roll: String = ""
    var strForwardedViaStatus: String = ""
    var strForwardeTo: String = ""
    var strForwardeName: String = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
            ...
            override fun onItemSelected(
                ...
                user_institute = spinner_selectIns.selectedItem.toString()
                 ...
                 if (user_institute=="Select Institute") {
                    Toast.makeText(applicationContext, "please select Institute ", Toast.LENGTH_LONG).show()
                }else if (strForwardeTo=="Select") {
                    Toast.makeText(applicationContext, "please select Forward To ", Toast.LENGTH_LONG).show()
                }
        ...
        array_forwardedTo.add("Select")




//        if (roll.equals("Principal", ignoreCase = true) || roll.equals("Dean", ignoreCase = true)) {
...
//        }
        ...
        spinnerForwardeTo.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(
                ...
                hodName.clear()
                deptName.clear()
                if (strForwardeTo.equals("Select")) {
                            ...
                            for (i in 0..listSize - 1) {
                                ...
                                if (result.Data17!![i].G_ID.equals(G_ID)) {
                                    ...
                                    /*    if (users.isEmpty()) {
                                            ...
                                            val adapter =
                                                GrievanceAdapterHodShow(users, this@GrievanceFull)
                                        }*/
        ...
        btn_Submit.setOnClickListener {
            ...
            if (roll.equals("GREVIANCE_CELL")) {
                if (user_institute.equals("Select Institute")) {
                    GenericUserFunction.DisplayToast(this@GrievanceFull, "Please Select Institute")
                    return@setOnClickListener
                }

            }
            if (strForwardedViaStatus.equals("Select")) {
...
// else if (strForwardeTo.equals("Select")) {
////                GenericUserFunction.DisplayToast(this@GrievanceFull, "Select Forward to ")
////            } else if (selected_Department.equals("")) {
////                GenericUserFunction.DisplayToast(this@GrievanceFull, "Select Complaint To ")
////            } else {
//
//            }
...
//        instituteName = "JNMC"
        ...
        mServices.GetGreivanceData(user_institute, string)
            .enqueue(object : Callback<APIResponse> {
                override fun onFailure(call: Call<APIResponse>, t: Throwable) {
                    GenericUserFunction.showNegativePopUp(
                        this@GrievanceFull,
                ...
                override fun onResponse(call: Call<APIResponse>, response: Response<APIResponse>) {
                    ...
                    {
                        GenericUserFunction.showNegativePopUp(this@GrievanceFull,"No data found against your choice please select proper choices")
                    }
                }
